...
class Sozfo_View_Helper_TinyMce extends Zend_View_Helper_Abstract
{
    ...
    protected $_defaultScript = '/js/tiny_mce/tiny_mce.js';
    ...
    protected function _renderScript ()
    {
        ...
        $this->view->headScript()->appendFile('/MiUNEControlDeEstudios/js/tiny_mce/tiny_mce.js');
    ...
    {
        $script = 'function rendertinyMCE() { tinyMCE.init({' . PHP_EOL;
