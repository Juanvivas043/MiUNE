 ...
 */
class Une_Cde_Reportes_CertificacionPensum {
    ...
    public function generar($Ci, $Estudiante) {
        ...
        Zend_Controller_Front::getInstance()->getResponse()->appendBody($this->HTML($Ci, $Estudiante, "Certificación De Pensum"));
    }
    ...
    <tbody >
        ...
        <tr>
            <td colspan="3"><p align="justify">
                                La suscrita, ABOG. EUGENIA MORA HIDALGO, Secretaria (E) de la Universidad Nueva Esparta, certifica que: El Pensum de Estudios que se anexa, correspondiente a la Facultad de: <?php echo $Estudiante[0]['facultad']; ?>. Escuela de: <?php echo $Estudiante[0]['escuela']; ?>, es auténtico, está vigente para la fecha de su expedición, va sellado y firmado
                                y pertenece al (la) Ciudadano (a): <b><?php echo $Estudiante[0]['apellido']; ?>, <?php echo $Estudiante[0]['nombre']; ?></b>, con Cédula de Identidad N°: <b><?php echo $Estudiante[0]['Ci']; ?></b>. Certificado que se expide a solicitud de la parte interesada en Caracas, <?php if($Estudiante[0]['dia']=='01'){ echo "al";}else{ echo "a los";}; ?> <?php echo $Estudiante[0]['diatxt']; ?> <?php if($Estudiante[0]['día']=='01'){ echo "día";}else{ echo "días";}; ?> del mes de <?php echo $Estudiante[0]['mes']; ?> de <?php echo $Estudiante[0]['añotxt']; ?>.
            </p></td>
        </tr>
        <tr>
            <td  colspan="3" height="80">&nbsp; </td>
