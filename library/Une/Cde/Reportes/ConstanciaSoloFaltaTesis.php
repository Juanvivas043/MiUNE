 ...
 */
class Une_Cde_Reportes_ConstanciaSoloFaltaTesis {
    ...
    public function generar($Ci, $Estudiante) {
        ...
        Zend_Controller_Front::getInstance()->getResponse()->appendBody($this->HTML($Ci, $Estudiante, "Constacia Solo Falta Tesis"));
    }
    ...
    <tbody >
        ...
        <tr>
            <td colspan="3"><p align="justify">
                ...
                cursó en la Facultad de: <?php echo $Estudiante[0]['facultad']; ?>. Escuela de: <?php echo $Estudiante[0]['escuela']; ?>, todas las
                asignaturas del pensum de estudios. Solo debe aprobar Tesis de Grado, para optar al título de
                <?php
