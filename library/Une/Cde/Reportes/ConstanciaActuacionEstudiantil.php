 ...
 */
class Une_Cde_Reportes_ConstanciaActuacionEstudiantil {
    ...
    public function generar($Ci, $Estudiante) {
        ...
        Zend_Controller_Front::getInstance()->getResponse()->appendBody($this->HTML($Ci, $Estudiante, "Constacia de Actuación Estudiantil"));
    }
    ...
    <tbody >
        ...
        <tr>
            <td colspan="3"><p align="justify">
                La suscrita, ABOG. EUGENIA MORA HIDALGO, Secretaria (E) de la Universidad Nueva Esparta hace constar que en el expediente
                correspondiente al (a la) ciudadano (a) Bachiller: <b><?php echo $Estudiante[0]['apellido']; ?>, <?php echo $Estudiante[0]['nombre']; ?></b>,
                con Cédula de identidad N°: <b><?php echo $Estudiante[0]['Ci']; ?></b>, quien ha sido estudiante de la Escuela de: <?php echo $Estudiante[0]['escuela']; ?>.
                en la Facultad de: <?php echo $Estudiante[0]['facultad']; ?>, de esta Universidad, no figuran registradas sanciones académicas
                ni disciplinarias hasta la presente fecha.
            </p></td>
        </tr>
        <tr>
            <td colspan="3"><p align="justify">
