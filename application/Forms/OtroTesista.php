...
class Forms_OtroTesista extends Zend_Form {
    /**
    ...
    public function init() {
		...
		$changeCI = "$.getJSON(urlAjax + 'exists/data/' + escape($('#otrotesista').find(':input').serialize()), function(data){executeCmdsFromJSON(data)});";

        $this->setMethod('post');
        $this->setName('otrotesista');
        	
        $id   = new Zend_Form_Element_Hidden('id');
		$id->removeDecorator('label')
                   ->removeDecorator('HtmlTag');

        $permiso   = new Zend_Form_Element_Hidden('permiso_tesista');
