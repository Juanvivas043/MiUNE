...
class Forms_Tutortesis extends Zend_Form {
    /**
    ...
    public function init() {
	    ...
	    $changeCI = "$.getJSON(urlAjax + 'existstutor/data/' + escape($('#tutor').find(':input').serialize()), function(data){executeCmdsFromJSON(data)});";
        ...
        $permiso   = new Zend_Form_Element_Hidden('permiso_tutor');
        $permiso->removeDecorator('label')
                   ->removeDecorator('HtmlTag');                   
       ...
       $ci->setLabel('C.I.:')
        ...
        $titulo_academico = new Zend_Form_Element_Text('titulo_academico');
        $titulo_academico->setLabel('Titulo Academico:')
            ->addFilter('StripTags')
            ->addFilter('StringTrim')
            ->addValidator('NotEmpty') 
            ->setAttrib('size', 35)
...
//                                 $nacionalidad,
    ...
    public function removeElementDatosTesis(){
        $this->removeElement('foto');
        $this->removeElement('pk_usuario');
        $this->removeElement('segundo_nombre');
        $this->removeElement('segundo_apellido');
        $this->removeElement('titulo_academico');
        $this->removeElement('fechanacimiento');
        $this->removeElement('telefono');
        $this->removeElement('correo');
        $this->removeElement('direccion');       
    }
