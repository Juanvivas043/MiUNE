...
class Evaluations_EvaluacioncoordinadorController extends Zend_Controller_Action {
    ...
    public function init() {
        ...
        $this->grupo = $this->evaluacion->getGrupoCoordinador($this->ci);
    ...
    public function tablaAction() {
        if ($this->_request->isXmlHttpRequest()) {
            ...
            $profesores = $this->evaluacion->getProfesorPorSede($this->periodo,$this->grupo[0]['pk_atributo'],$this->grupo[0]['pk_usuariogrupo'] );
    ...
    public function evaluacionAction(){
      ...
      if ($this->_request->isXmlHttpRequest()) {
          ...
          if (empty($this->evaluacion->getAsignacionEncuestaDir($this->grupo[0]['pk_usuariogrupo'],$this->ugprofesor))) {
            ...
            $this->evaluacion->insertPreEvaluacionDir($this->grupo[0]['pk_usuariogrupo'], 36,$this->ugprofesor);
          }
