...
class Reports_ListadopirareinscritosController extends Zend_Controller_Action {
...
//		$this->filtros->setType('seccion', FILTER_TYPE_SECCION_PADRES);
    ...
    public function indexAction() {
        $this->view->title = "Reportes \ Listado Estudiantes En P.I.R.A. Reinscritos";
    ...
    public function listAction() {
        if ($this->_request->isXmlHttpRequest()) {
            ...
            $ra_data = $this->RecordAcademico->getPiraReinscritos($this->_params['filters']['periodo'],$this->_params['filters']['sede'],$this->_params['filters']['escuela']);
            ...
            $ra_property_column = array( array('column'   => 'pk_usuario',
                                               'primary'  => true,
                                               'hide'     => true),
                                         array('name'     => '#',
                                               'width'    => '20px',
    ...
    public function descargarAction() {
		...
		$report = APPLICATION_PATH . '/modules/reports/templates/Pira/pirareinscritos.jrxml';
		$filename    = 'listapirareinscritos';
