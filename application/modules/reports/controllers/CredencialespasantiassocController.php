...
class Reports_CredencialespasantiassocController extends Zend_Controller_Action {
    ...
    public function indexAction() {
        $this->view->title = "Reportes \ Credenciales Pasantias Sociales";
    ...
    public function listAction() {
        if ($this->_request->isXmlHttpRequest()) {
            ...
            $ra_data = $this->inscripcionespasantias->getListadocredencialservicio($this->_params['filters']['periodo'],$this->_params['filters']['sede'],$this->_params['filters']['escuela']);
    ...
    public function descargarAction() {
		...
		$report = APPLICATION_PATH . '/modules/reports/templates/Credencialespasantiassoc/credencialessc.jrxml';
                
		$filename    = 'credencialessc';
