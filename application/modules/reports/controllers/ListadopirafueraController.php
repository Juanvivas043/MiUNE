...
class Reports_ListadopirafueraController extends Zend_Controller_Action {
...
//		$this->filtros->setType('seccion', FILTER_TYPE_SECCION_PADRES);
    ...
    public function indexAction() {
        $this->view->title = "Reportes \ Listado Estudiantes que salieron por P.I.R.A. ";
    ...
    public function listAction() {
        if ($this->_request->isXmlHttpRequest()) {
            ...
            $ra_data = $this->RecordAcademico->getFueraPira($this->_params['filters']['periodo'],$this->_params['filters']['sede'],$this->_params['filters']['escuela']);
    ...
    public function descargarAction() {
		...
		$report = APPLICATION_PATH . '/modules/reports/templates/Pira/pirafuera.jrxml';
		$filename    = 'listapirafuera';
