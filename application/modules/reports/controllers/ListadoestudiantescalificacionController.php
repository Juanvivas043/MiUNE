...
class Reports_ListadoestudiantescalificacionController extends Zend_Controller_Action {
...
//		$this->filtros->setType('seccion', FILTER_TYPE_SECCION_PADRES);
    ...
    public function indexAction() {
        $this->view->title = "Reportes \ Listado de Estudiantes con Calificacion";
    ...
    public function listAction() {
        if ($this->_request->isXmlHttpRequest()) {
            ...
            $ra_data = $this->RecordAcademico->getEstudiantesCalificacion($this->_params['filters']);
    ...
    public function descargarAction() {
		...
		$report = APPLICATION_PATH . '/modules/reports/templates/Listadoestudiantes/Listadoestudiantecalificaciones.jrxml';
		$filename    = 'listaCalificaciones';
      ...
      if(!is_array($Params['chkEstudiante'])){
		...
		$params      = "'Sede=string:{$Params['selSede']}|Periodo=string:{$Params['selPeriodo']}|Escuela=string:{$Params['selEscuela']}|Semestre=string:{$Params['selSemestre']}|Materia=string:{$Params['selMateria']}|Seccion=string:{$Params['selSeccion']}|CIs=string:{$Estudiantes}|Pensum=string:{$Params['selPensum']}|image=string:{$imagen}'";
