...
class Reports_CertificacionPensumController extends Zend_Controller_Action {
    ...
    function preDispatch() {
     ...
     public function indexAction() {
        $this->view->title      = "Reportes \ Certificación \ Pensum";
    ...
    public function descargarAction() {
        if(ctype_digit($this->Ci) && ctype_digit($this->Escuela)) {
            ...
            $this->certificacionpensum->generar($this->Ci, $Estudiante);
