<?php
class Mantenimiento_ReiniciarpassController extends Zend_Controller_Action{
    private $Title = "CDT Reiniciar pass";
      ...
      public function busquedaAction(){
            ...
            if($this->validar($ci)){  
                ...
                if(!$entro && $usuariodoce[0]['nombre']!=""){
                    ...
                    $json[] = '$("#mensaje").html("Contactar con Control de Estudio ")';
