...
class Profile_ChangepasswordsoController extends Zend_Controller_Action {
    public function init() {
        Zend_Loader::loadClass('Models_DbTable_Usuarios');
        Zend_Loader::loadClass('Forms_Passwordso');
    ...
    public function indexAction() {
        $this->view->title = "Cambiar Contraseña de Operaciones Especiales";
        $this->view->form  = new Forms_Passwordso();
        ...
        if ($this->_request->isPost()) {
            if ($this->view->form->isValid($_POST)) {
                ...
                if($Row['passwordhash'] == $PwdH && $NewH == $RepH && $Row['passwordhash'] <> $RepH) {
                    $Rows = $this->usuario->changePasswordSo($id->pk_usuario, $Rep);
