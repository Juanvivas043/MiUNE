...
class Consultas_ListadoegresadosController extends Zend_Controller_Action {
    ...
    public function indexAction() {
        $this->view->title                  = "Consultas \ Listado de Egresados";
    ...
    public function listAction() {
        if ($this->_request->isXmlHttpRequest()) {
            ...
            $PeriodoActual = $this->_params['filters']["selPeriodo"] ; //Obtiene el periodos
            $HtmlObjectName = 'pk_usuario';
            $rows = $this->Usuarios->getEgresadosPeriodo($PeriodoActual); 
            ...
            // Verificamos que traiga valores, sino genera una alerta.
            
            if(empty($rows)){
                $HTML =  $this->SwapBytes_Html_Message->alert("Aun no hay egresados en este periodo.");
            }else{
