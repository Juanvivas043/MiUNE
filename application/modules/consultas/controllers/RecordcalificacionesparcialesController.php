...
class Consultas_RecordcalificacionesparcialesController extends Zend_Controller_Action {

    private $Title = 'Consultas \ Record Académico Parcial';
    ...
    public function indexAction() {
      $this->view->title = "Consultas \ Record Académico Parcial";
    ...
    public function periodoAction(){
        $this->custom->fillSelect(array('usuario' => $this->AuthSpace->userId,'action' => 'periodo'));
    }

    public function sedeAction() {
        
        $this->custom->fillSelect(array('usuario' => $this->AuthSpace->userId,'action' => 'sede'));
    }
    
    public function escuelaAction() {
        $this->custom->fillSelect(array('usuario' => $this->AuthSpace->userId,'action' => 'escuela', 'periodo' => $this->_params['filters']['periodo']));    
    }

    public function pensumAction() {
        
        $this->custom->fillSelect(array('usuario' => $this->AuthSpace->userId,'action' => 'pensum', 'escuela' => $this->_params['filters']['escuela']));
    }
    ...
    public function listAction(){
        if ($this->_request->isXmlHttpRequest()) {
            ...
            $regimenesHistoricosEstudiante = $this->asignaturas->getRegimenHistoricoEstudiante($periodo, $escuela, $pensum);

            if(!empty($regimenesHistoricosEstudiante)){

              foreach ($regimenesHistoricosEstudiante as $key => $regimen) {

                  $RecordPorRegimen = $this->asignaturas->getRecordAcademicoParcialEstudiante($periodo, $regimen['pk_regimen_historico'], $sede, $pensum, $escuela, null);
