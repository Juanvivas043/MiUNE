<?php
class Consultas_EstudiantesproyectoController extends Zend_Controller_Action {

  private $_title = 'Consultas \ Estudiantes Inscritos en Proyectos';
  ...
  public function listAction() {
      ...
      $rows = $this->inscripcionespasantias->getEstudiantesProyecto($this->_params['filters']['Periodo'], $this->_params['filters']['Sede'],$this->_params['filters']['Proyecto']);
  ...
  public function descargarAction() {
    ...
    $proyecto = $this->inscripcionespasantias->getProyecto($Params['Proyecto']);
    ...
    $report = APPLICATION_PATH . '/modules/reports/templates/Serviciocomunitario/EstudianteProyecto.jrxml'; 
    $filename    = 'Servicio Comunitario';
    $filetype    = strtolower($Params['rdbFormat']);
    $params      = "'Sede=string:{$Params['Sede']}|Periodo=string:{$Params['Periodo']}|Proyecto=string:{$Params['Proyecto']}|nombreSede=string:{$sede}|nombreProyecto=string:{$proyecto[0]["proyecto"]}'";
