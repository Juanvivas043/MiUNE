<?php
class Transactions_TutorespsController extends Zend_Controller_Action {   

    private $_Title   = 'Transacciones \ Lista de Tutores Institucionales';
    ...
    public function init() {
        ...
        Zend_Loader::loadClass('Forms_Tutorps');
...
//    FORM 
     ...
     $this->view->form = new Forms_Tutorps();
...
public function addoreditloadAction() {
    ...
    if(is_numeric($this->_params['modal']['id']) && $this->_params['modal']['id'] > 0) {
        ...
        $title = 'Editar Tutor Institucional';
            ...
            $title = 'Agregar Tutor Institucional'; 
	}
...
// cargamos Formulario ver
    public function viewAction() {
        ...
        $this->SwapBytes_Crud_Form->setJson($json); 
        $this->SwapBytes_Crud_Form->setProperties($this->view->form, $dataRow, 'Ver Tutor Institucional');
	...
	$dataRow = $this->Usuarios->getRow($this->_params['modal']['id']);
	$dataRow['id'] = $this->_params['modal']['id'];
        $tutorasignado = $this->Contactos->gettutorconasignaciones($dataRow['id']);  
