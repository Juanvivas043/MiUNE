...
class Transactions_VerdefensastutorController extends Zend_Controller_Action {

private $_Title   = 'Transacciones \ Ver Defensas (Tutor)';
...
function preDispatch() {
    ...
    public function listAction(){
           if ($this->_request->isXmlHttpRequest()) {
                ...
                $rows = $this->tesis->getTutorTesisparaDefensa($periodo,$cedula);
                ...
                if(isset($rows) && count($rows) > 0) {
          	            ...
          	            $columns = array( array('name'    => 'Nombres',
                                                 'width'   => '150px',
                    ...
                    $HTML = $this->SwapBytes_Html_Message->alert("No tiene ninguna tesis asignada");
