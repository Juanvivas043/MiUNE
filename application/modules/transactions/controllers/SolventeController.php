<?php
class Transactions_SolventeController extends Zend_Controller_Action{
    private $Title = "Solvente";
     ...
     public function buscarAction(){
          ...
          if($this->validar($ci)){  
                ...
                if($mostrar){
                    ...
                    $json[] = '$("#mensaje").hide()';
                    if($solvente){
                        $json[] = '$("#est_usuariotxt").html("<b><p style=color:green;>Solvente</p></b>")';
                    }else{
                        $json[] = '$("#est_usuariotxt").html("<b><p style=color:red;>No esta solvente</p></b>")';
